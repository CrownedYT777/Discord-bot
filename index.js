        ...
        data: {
            ...
            options: [
                { 
                    ...
                    options: [
                        { type: 5, name: 'enabled', description: 'Enable or disable anti-nuke protection', required: true },
                        { type: 7, name: 'log_channel', description: 'Channel to log anti-nuke events (required when enabling)', required: false }
                    ]
                },
                { 
                    type: 1, 
                    ...
                    options: [
                        { 
                            type: 3, 
                            name: 'punishment', 
                            description: 'Set punishment for anti-nuke violators', 
                            required: false,
                            choices: [
                                { name: 'Ban', value: 'ban' },
        ...
        async execute(interaction) {
            ...
            switch (subcommand) {
                case 'toggle': {
                    ...
                    if (enabled) {
                        // When enabling, log channel is required
                        const logChannel = interaction.options.getChannel('log_channel');
                        
                        if (!logChannel) {
                            return interaction.reply({ content: "❌ A log channel is required when enabling anti-nuke protection.", ephemeral: true });
                        }
        ...
        data: {
            ...
            options: [
                { 
                    ...
                    options: [
                        { type: 5, name: 'enabled', description: 'Enable or disable anti-raid protection', required: true },
                        { type: 7, name: 'log_channel', description: 'Channel to log anti-raid events (required when enabling)', required: false }
                    ]
                },
                { 
                    type: 1, 
                    ...
                    options: [
                        { 
                            type: 3, 
                            name: 'action', 
                            description: 'Action to take on raid detection', 
                            required: false,
                            choices: [
            ...
            switch (subcommand) {
                case 'toggle': {
                    ...
                    if (enabled) {
                        ...
                        if (!logChannel) {
                            return interaction.reply({ content: "❌ A log channel is required when enabling anti-raid protection.", ephemeral: true });
                        }
        ...
        data: {
            ...
            options: [
                { 
                    ...
                    options: [
                        { type: 5, name: 'enabled', description: 'Enable or disable anti-spam protection', required: true },
                        { type: 7, name: 'log_channel', description: 'Channel to log anti-spam events (required when enabling)', required: false }
                    ]
                },
                { 
                    type: 1, 
                    ...
                    options: [
                        { 
                            type: 3, 
                            name: 'punishment', 
                            description: 'Set punishment for spammers', 
                            required: false,
                            choices: [
            ...
            switch (subcommand) {
                case 'toggle': {
                    ...
                    if (enabled) {
                        ...
                        if (!logChannel) {
                            return interaction.reply({ content: "❌ A log channel is required when enabling anti-spam protection.", ephemeral: true });
                        }
